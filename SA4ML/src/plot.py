...
def main(use_pre_generated_files: False):
    ...
    res_df = get_all_data(
        results,
        baselines=["optimum", "no_retrain", "periodic", "reactive", "random", "delta_retrain"],
        time_interval=10,
        fpr_thresholds=[1], 
    ...
    targets = [
        ...
        f'timeInterval_{TIME_INTERVAL}-baseline_delta_retrain-{settings}-nopModels_random_forest-askPrism_True-seed_1',
